...
# You will be given a list of integers and you will have to add some code
# to find a specific number in a list and return it.

# Instructions
#
# 1. Under the num_list create a new for loop and print out each value on the list in sequential order.
# 2. Inside the for loop, create a condition that will look for all numbers that
# are greater than 45 and print out only numbers that meet that condition
